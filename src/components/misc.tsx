...
export const hardBreak = () => <View><Text>{`\n`}</Text></View>
...
export const defaultUnknownMarkFactory: PortableTextComponent<PortableTextBlock> = () => {
    return (props: PortableTextComponentProps<PortableTextBlock>) => {
        ...
        console.warn(
            `Unknown mark type "${mark?._type || "undefined"}", please specify a component for it in the \`components.marks\` prop`,
        )
...
export const defaultUnknownTypeFactory: PortableTextComponent<PortableTextBlock> = () => {
    return (props: PortableTextComponentProps<PortableTextBlock>) => {
        ...
        return (<View style={{ visibility: 'hidden' }} key={value._key}>
            <Text>{warning}</Text>
        </View >)
    }
}
...
export const defaultUnknownBlockStyleFactory: PortableTextComponent<PortableTextBlock> = (styles: PortableTextStyles, baseFontSize: number) => {
    return (props: PortableTextComponentProps<PortableTextBlock>) => {
        ...
        console.warn(
            `Unknown block style "${block.style || "undefined"}", please specify a component for it in the \`components.block\` prop`,
        )
...
export const defaultUnknownListFactory: PortableTextComponent<ReactPortableTextList> = () => {
    return (props: PortableTextComponentProps<PortableTextBlock>) => {
        ...
        console.warn(
            `Unknown list style "${block.listItem || "undefined"}", please specify a component for it in the \`components.list\` prop`,
        )
...
export const defaultUnknownListItemFactory: PortableTextComponent<PortableTextBlock> = () => {
    return (props: PortableTextComponentProps<PortableTextBlock>) => {
        ...
        console.warn(
            `Unknown list item style "${block?.listItem || "undefined"}", please specify a component for it in the \`components.list\` prop`,
        )
